...
import { ArrowLeft, Check, Calendar as CalendarIcon, Sparkles } from 'lucide-react';
...
const FastTip = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-gradient-to-b from-background to-amber-50/10">
      ...
      <div className="flex-grow flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-md bg-white/80 backdrop-blur-sm shadow-lg rounded-xl p-6 border border-amber-100">
          ...
          <Button 
            className="gold-button w-full py-6 text-lg relative group overflow-hidden shadow-lg"
            disabled={amount <= 0}
            onClick={handleSave}
          >
